...
data.v_dis(56806:end) = data.v_dis(56806:end) - 0.006; 

I = [56406 56806];
p = polyfit(I,[data.v_dis(I(1)) data.v_dis(I(2))],1);
data.v_dis(I(1):I(2)) = polyval(p,I(1):I(2)); 

data.v_dis(69790:end) = data.v_dis(69790:end) - 0.004; 

I = [69490 69790];
p = polyfit(I,[data.v_dis(I(1)) data.v_dis(I(2))],1);
data.v_dis(I(1):I(2)) = polyval(p,I(1):I(2)); 

data.v_dis(143510:end) = data.v_dis(143510:end) - 0.01; 

I = [143510-300 143510];
p = polyfit(I,[data.v_dis(I(1)) data.v_dis(I(2))],1);
data.v_dis(I(1):I(2)) = polyval(p,I(1):I(2)); 

data.v_dis(173400:end) = data.v_dis(173400:end) - 0.012; 

I = [173111 173400];
p = polyfit(I,[data.v_dis(I(1)) data.v_dis(I(2))],1);
data.v_dis(I(1):I(2)) = polyval(p,I(1):I(2)); 

data.v_dis(206988:end) = data.v_dis(206988:end) - 0.01; 
